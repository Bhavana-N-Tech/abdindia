<?php
$page_title = 'IT Services | AB&D Software India Pvt Ltd';
$page_desc  = 'AB&D Software India offers software licensing, IT consulting, cybersecurity, cloud, developer tools, document automation and managed renewals.';
  ...
  <div class="container">
    <div class="page-hero-inner">
      ...
      <div class="page-hero-content">
        <span class="page-hero-label"><i class="fa-solid fa-gears"></i> &nbsp;Our Services</span>
        <h1>IT Services for Smarter Technology Decisions<span class="red-dot">.</span></h1>
        <p>From software licensing and procurement to cybersecurity, cloud, developer tools and managed renewals, AB&amp;D helps organizations simplify and strengthen their IT ecosystem.</p>
        <div class="page-hero-actions">
          <a href="#all-services" class="btn btn-primary"><i class="fa-solid fa-gears"></i> Explore Services</a>
      ...
      <div class="page-hero-visual">
        <div class="hero-dashboard">
          <div class="hero-dash-header">
            ...
            <div class="hero-dash-dot"></div>
            <div class="hero-dash-dot"></div>
            <span class="hero-dash-title">Services Overview</span>
          </div>
          <div class="hero-float-cards">
            ...
            <div class="hero-float-card">
              ...
              <div class="hfc-title">Cloud Infrastructure</div>
              <div class="hfc-sub">Virtualization & Support</div>
            </div>
            <div class="hero-float-card">
              ...
              <div class="hfc-sub">IDEs · Testing & QA</div>
            </div>
            <div class="hero-float-card">
              ...
              <div class="hfc-sub">Managed Lifecycle</div>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="container">
    ...
    <div class="cards-grid-3" style="margin-bottom: 2rem;">
      ...
      <div class="card reveal" style="border-top: 4px solid var(--clr-blue);">
        ...
        <p class="card-desc">End-to-end management of on-premises, hybrid, and multi-cloud infrastructure, including servers, storage, virtualization platforms, backup and recovery, databases, and network operations. Our services focus on maximizing availability, performance, scalability, and operational efficiency.</p>
      ...
      <div class="card reveal reveal-delay-2" style="border-top: 4px solid var(--clr-rose);">
        ...
        <p class="card-desc">Comprehensive management of endpoint assets throughout their lifecycle—from procurement, provisioning, imaging, deployment, patch management, software distribution, and asset tracking to refresh, retirement, and secure disposal. Ensures enhanced user productivity, endpoint security, compliance, and asset visibility across the enterprise.</p>
      ...
      <div class="card reveal" style="border-top: 4px solid var(--clr-emerald);">
        ...
        <p class="card-desc">End-to-end management of enterprise applications across planning, development, testing, deployment, maintenance, upgrades, and retirement. We help organizations improve application performance, governance, release management, change control, and operational support while ensuring alignment with business objectives.</p>
      ...
      <div class="card reveal reveal-delay-1" style="border-top: 4px solid var(--clr-amber);">
        ...
        <h3 class="card-title">Governance, Risk &amp; Compliance (GRC) Services</h3>
        <p class="card-desc">Compliance assessments, security audits, policy reviews, risk assessments, and control validation aligned with frameworks such as DPDP, ISO 27001, NIST, CIS, PCI-DSS, and industry-specific regulatory requirements to ensure compliance readiness and risk reduction.</p>
      ...
      <div class="card reveal reveal-delay-2" style="border-top: 4px solid var(--clr-violet);">
        ...
        <h3 class="card-title">Technology Consulting &amp; Advisory Services</h3>
        <p class="card-desc">Strategic consulting services covering enterprise architecture, cybersecurity strategy, infrastructure modernization, cloud adoption, operational excellence, IT governance, and technology roadmap development to support long-term business growth.</p>
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 3rem; align-items: start; margin-bottom: 1.5rem;">
      ...
      <div class="reveal">
        ...
        <ul style="display: grid; grid-template-columns: 1fr; gap: 0.8rem;">
          ...
          <li style="display:flex; align-items:center; gap:0.6rem; font-weight:600; color:var(--clr-muted);"><i class="fa-solid fa-circle-check" style="color:var(--clr-blue);"></i> Cyber security Analysts &amp; Security Engineers</li>
      ...
      <div class="card reveal reveal-delay-2" style="border-top: 4px solid var(--clr-red); background: var(--clr-bg); padding: 2.2rem;">
        ...
        <ul style="display: flex; flex-direction: column; gap: 0.7rem;">
          <li style="display:flex; gap:0.5rem; font-size:0.9rem; line-height:1.4;"><span style="color:var(--clr-red); font-weight:bold;">✓</span> <span>Rapid deployment of pre-vetted, certified IT professionals</span></li>
          <li style="display:flex; gap:0.5rem; font-size:0.9rem; line-height:1.4;"><span style="color:var(--clr-red); font-weight:bold;">✓</span> <span>Flexible engagement models for short-term, long-term, or project-based requirements</span></li>
          <li style="display:flex; gap:0.5rem; font-size:0.9rem; line-height:1.4;"><span style="color:var(--clr-red); font-weight:bold;">✓</span> <span>Expertise across on-premises, hybrid, and cloud environments</span></li>
          <li style="display:flex; gap:0.5rem; font-size:0.9rem; line-height:1.4;"><span style="color:var(--clr-red); font-weight:bold;">✓</span> <span>Reduced recruitment, onboarding, and training overhead</span></li>
          <li style="display:flex; gap:0.5rem; font-size:0.9rem; line-height:1.4;"><span style="color:var(--clr-red); font-weight:bold;">✓</span> <span>Faster project execution and reduced time-to-productivity</span></li>
          <li style="display:flex; gap:0.5rem; font-size:0.9rem; line-height:1.4;"><span style="color:var(--clr-red); font-weight:bold;">✓</span> <span>Seamless integration with existing teams and processes</span></li>
          <li style="display:flex; gap:0.5rem; font-size:0.9rem; line-height:1.4;"><span style="color:var(--clr-red); font-weight:bold;">✓</span> <span>Access to specialized skills for mission-critical initiatives</span></li>
          <li style="display:flex; gap:0.5rem; font-size:0.9rem; line-height:1.4;"><span style="color:var(--clr-red); font-weight:bold;">✓</span> <span>Backed by 15+ years of enterprise infrastructure and technology services experience</span></li>
        </ul>
  ...
  <div class="container">
    ...
    <div class="cards-grid-3" style="display: flex; flex-wrap: wrap; gap: 1.5rem; justify-content: center;">
      ...
      <div class="card reveal" style="flex: 0 0 calc((100% - 1.5rem) / 2); width: calc((100% - 1.5rem) / 2); border-top: 4px solid var(--clr-blue);">
        ...
        <p class="card-desc">Rapidly address urgent resource requirements with skilled, deployment-ready IT professionals to support critical operations, migrations, upgrades, or project deadlines.</p>
      </div>
      ...
      <div class="card reveal reveal-delay-1" style="flex: 0 0 calc((100% - 1.5rem) / 2); width: calc((100% - 1.5rem) / 2); border-top: 4px solid var(--clr-indigo);">
        ...
        <p class="card-desc">Extend your internal IT capabilities with dedicated experts while minimizing recruitment, onboarding, retention, and workforce management challenges.</p>
      </div>
      ...
      <div class="card reveal" style="flex: 0 0 calc((100% - 1.5rem) / 2); width: calc((100% - 1.5rem) / 2); border-top: 4px solid var(--clr-rose);">
        ...
        <p class="card-desc">Leverage complete, outcome-driven teams for infrastructure deployments, data center migrations, cloud adoption, network transformations, security initiatives, and technology modernization projects.</p>
      </div>
    ...
    <div class="card reveal" style="border-top: 4px solid var(--clr-blue); background: var(--clr-bg); padding: 3rem 2rem;">
      ...
      <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 1.5rem;">
        ...
        <div style="display: flex; gap: 0.8rem; align-items: flex-start;">
          ...
          <div>
            <h4 style="margin-bottom: 0.3rem;">Technology Assessment &amp; Solution Advisory</h4>
        ...
        <div style="display: flex; gap: 0.8rem; align-items: flex-start;">
          ...
          <div>
            <h4 style="margin-bottom: 0.3rem;">Pre- and Post-Sales Technical Consulting</h4>
...
<section class="cta-section" aria-label="Services CTA">
  <div class="container">
    <div class="reveal">
      <span class="section-label" style="background:rgba(26,86,219,0.12);border-color:rgba(26,86,219,0.25);color:#93c5fd;">Get Started</span>
      ...
      <div class="cta-actions">
        <a href="contact.php" class="btn btn-primary"><i class="fa-solid fa-calendar-check"></i> Request Consultation</a>
        <a href="solutions.php" class="btn btn-outline"><i class="fa-solid fa-arrow-right"></i> Explore Solutions</a>
      </div>
    </div>
  </div>
</section>
