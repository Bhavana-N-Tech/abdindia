...
<footer class="footer" role="contentinfo">
  <div class="container">
    <div class="footer-grid">
      ...
      <div class="footer-brand">
        ...
        <div style="display:flex;gap:0.6rem;margin-top:0.5rem;">
          <a href="#" aria-label="LinkedIn" style="width:34px;height:34px;border-radius:9px;background:rgba(255,255,255,0.07);border:1px solid rgba(255,255,255,0.1);display:flex;align-items:center;justify-content:center;color:rgba(255,255,255,0.5);font-size:0.85rem;transition:all 0.25s;" onmouseover="this.style.background='rgba(37,99,235,0.3)';this.style.color='#fff';" onmouseout="this.style.background='rgba(255,255,255,0.07)';this.style.color='rgba(255,255,255,0.5)';"><i class="fa-brands fa-linkedin-in"></i></a>
          <a href="#" aria-label="Twitter" style="width:34px;height:34px;border-radius:9px;background:rgba(255,255,255,0.07);border:1px solid rgba(255,255,255,0.1);display:flex;align-items:center;justify-content:center;color:rgba(255,255,255,0.5);font-size:0.85rem;transition:all 0.25s;" onmouseover="this.style.background='rgba(37,99,235,0.3)';this.style.color='#fff';" onmouseout="this.style.background='rgba(255,255,255,0.07)';this.style.color='rgba(255,255,255,0.5)';"><i class="fa-brands fa-x-twitter"></i></a>
          <a href="#" aria-label="Email" style="width:34px;height:34px;border-radius:9px;background:rgba(255,255,255,0.07);border:1px solid rgba(255,255,255,0.1);display:flex;align-items:center;justify-content:center;color:rgba(255,255,255,0.5);font-size:0.85rem;transition:all 0.25s;" onmouseover="this.style.background='rgba(37,99,235,0.3)';this.style.color='#fff';" onmouseout="this.style.background='rgba(255,255,255,0.07)';this.style.color='rgba(255,255,255,0.5)';"><i class="fa-solid fa-envelope"></i></a>
        </div>
      </div>
    ...
    <div class="footer-bottom">
      <p class="footer-copy">&copy; 2026 <span>AB&amp;D Software India Pvt Ltd</span>. All Rights Reserved. Built for the Modern Enterprise.</p>
